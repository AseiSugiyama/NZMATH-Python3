...
more detailed description.
  ...
  Some functions connect to the Net.
  When your machine is not connected to the network, if you set this false,
  processing may become rarely high-speed.
  ...
  The module tries to load the user's config file named
