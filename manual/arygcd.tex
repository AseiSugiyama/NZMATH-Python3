...
%
  \subsection{arygcd\_w -- gcd over Eisenstein-integer}\linkedone{arygcd}{arygcd\_w}
   ...
   \negok This functions uses $(1-\omega)$-ary gcd algorithm, which is an generalization of the binary algorithm, proposed by I.B. Damg$\mathring{a}$rd and G.S. Frandsen \cite{Dam-Frand}. \\
   %\spacing
   % input, output document
   %\quad \param{a},\ \param{b} must be int, long or \linkingone{rational}{Integer}.\\
%
