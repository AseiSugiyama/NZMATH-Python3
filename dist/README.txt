...
The version 0.0.1 is a minor bug fix release.
...
The next step is to expand the NZMATH-0.0.1.tar.gz.  The way to do it
...
it as::
 ...
 $ gzip -cd NZMATH-0.0.1.tar.gz | tar xf -

Then, you have a child directory named NZMATH-0.0.1.
