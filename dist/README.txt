...
The version 0.7.0 is an enhancement release.
...
The next step is to expand the NZMATH-0.7.0.tar.gz.  The way to do it
...
Then, you have a child directory named NZMATH-0.7.0.
