...
The version 0.5.0 is an enhancement release.
...
The next step is to expand the NZMATH-0.5.0.tar.gz.  The way to do it
depends on your operating system.  On the systems with recent GNU tar,
you can do it with a single command::

 % tar xf NZMATH-0.5.0.tar.gz

where, % is the command line prompt.  Or with standard tar, you can do
it as::

 % gzip -cd NZMATH-0.5.0.tar.gz | tar xf -

Then, you have a child directory named NZMATH-0.5.0.
...
Copyright (c) 2003-2006, NZMATH development group, all right reserved.
