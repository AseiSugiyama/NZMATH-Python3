...
The version 0.0.0 is the first public release of NZMATH.  It is,
however, still on very early stage of development, and it should be
...
The next step is to expand the NZMATH-0.0.0.tar.gz.  The way to do it
depends on your operating system.  On the systems with GNU tar, you can
do it with a single command::

 $ tar zxf NZMATH-0.0.0.tar.gz

where, $ is the command line prompt.  Or with standard tar, you can do
it as::

 $ gzip -cd NZMATH-0.0.0.tar.gz | tar xf -

Then, you have a child directory named NZMATH-0.0.0.
...
please use it as usual packages.  For more information please refer
...
list with writing a mail containing a line of "add" in the body to
